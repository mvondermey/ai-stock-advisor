...
def print_final_summary(
    ...
    strategies_data.append(('Enhanced Volatility', final_enhanced_volatility_value_1y, enhanced_volatility_1y_return, enhanced_volatility_transaction_costs, enhanced_volatility_cash_deployed))
