...
def print_final_summary(
    ...
    final_sector_rotation_value_1y: float = None,
    ...
    final_momentum_volatility_hybrid_6m_value_1y: float = None,
    momentum_volatility_hybrid_6m_1y_return: float = None,
    final_momentum_volatility_hybrid_1y_value_1y: float = None,
    momentum_volatility_hybrid_1y_1y_return: float = None,
    final_momentum_volatility_hybrid_1y3m_value_1y: float = None,
    momentum_volatility_hybrid_1y3m_1y_return: float = None,
    ...
    momentum_volatility_hybrid_6m_transaction_costs: float = None,
    momentum_volatility_hybrid_1y_transaction_costs: float = None,
    momentum_volatility_hybrid_1y3m_transaction_costs: float = None,
    ...
    momentum_volatility_hybrid_6m_cash_deployed: float = None,
    momentum_volatility_hybrid_1y_cash_deployed: float = None,
    momentum_volatility_hybrid_1y3m_cash_deployed: float = None,
    ...
    strategies_data.append(('Mom-Vol Hybrid 6M', final_momentum_volatility_hybrid_6m_value_1y, momentum_volatility_hybrid_6m_1y_return, momentum_volatility_hybrid_6m_transaction_costs, momentum_volatility_hybrid_6m_cash_deployed))
    strategies_data.append(('Mom-Vol Hybrid 1Y', final_momentum_volatility_hybrid_1y_value_1y, momentum_volatility_hybrid_1y_1y_return, momentum_volatility_hybrid_1y_transaction_costs, momentum_volatility_hybrid_1y_cash_deployed))
    strategies_data.append(('Mom-Vol Hybrid 1Y/3M', final_momentum_volatility_hybrid_1y3m_value_1y, momentum_volatility_hybrid_1y3m_1y_return, momentum_volatility_hybrid_1y3m_transaction_costs, momentum_volatility_hybrid_1y3m_cash_deployed))
    strategies_data.append(('Price Acceleration', final_price_acceleration_value_1y, price_acceleration_1y_return, price_acceleration_transaction_costs, price_acceleration_cash_deployed))
    ...
    strategies_data.append(('Adaptive Ensemble', final_adaptive_ensemble_value_1y, adaptive_ensemble_1y_return, adaptive_ensemble_transaction_costs, adaptive_ensemble_cash_deployed))
    strategies_data.append(('Volatility Ensemble', final_volatility_ensemble_value_1y, volatility_ensemble_1y_return, volatility_ensemble_transaction_costs, volatility_ensemble_cash_deployed))
    strategies_data.append(('AI Volatility Ensemble', final_ai_volatility_ensemble_value_1y, ai_volatility_ensemble_1y_return, ai_volatility_ensemble_transaction_costs, ai_volatility_ensemble_cash_deployed))
    strategies_data.append(('Multi-TF Ensemble', final_multi_tf_ensemble_value_1y, multi_tf_ensemble_1y_return, multi_tf_ensemble_transaction_costs, multi_tf_ensemble_cash_deployed))
    ...
    strategies_data.append(('Dual Momentum', final_dual_mom_value_1y, dual_mom_1y_return, dual_mom_transaction_costs, dual_mom_cash_deployed))
