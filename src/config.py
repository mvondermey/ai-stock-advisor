...
MIN_PERFORMANCE_1Y = 0.0       # 0% minimum 1-year performance
MIN_PERFORMANCE_6M = 0.0       # 0% minimum 6-month performance
MIN_PERFORMANCE_3M = 0.0       # 0% minimum 3-month performance
ENABLE_PERFORMANCE_FILTERS = True   # ENABLED - But with 0 thresholds (no filtering)
